          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="Register_company.action" method="post">
                ...
                <input type="text" name="company_name" id="form3Example3cg" class="form-control form-control-lg" required="required" />
                </div>
                ...
                <div class="form-outline mb-4">
                 <label class="form-label" for="form3Example4cg">もう一度パスワード</label>
                  <input type="password" name="password2" id="form3Example4cg" class="form-control form-control-lg" required="required" />
                </div>
